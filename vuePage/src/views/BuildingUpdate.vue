...
<script>
    export default {
        ...
        methods: {
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        axios.put('http://172.20.10.8:8181/building/update',_this.ruleForm).then(function (resp) {
                            if(resp.data.code == 0){
        ...
        created() {
            ...
            axios.get('http://172.20.10.8:8181/building/findById/'+_this.$route.query.id).then(function (resp) {
