        ...
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item>
                <div class="button_container1">
                    <el-button size="medium" type="primary" @click="submitForm('ruleForm')">创建</el-button>
        ...
        methods: {
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        axios.post('http://172.20.10.8:8181/dormitoryAdmin/save',_this.ruleForm).then(function (resp) {
                            if(resp.data.code == 0){
