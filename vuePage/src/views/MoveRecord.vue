<template>
    ...
    padding:20px;">
        ...
        <el-table :data="tableData" border stripe style="width: 1150px;position: relative;top:-30px">
            ...
            <el-table-column header-align="center" align="center" prop="reason" label="迁出原因" >
            </el-table-column>
            <el-table-column header-align="center" align="center" prop="createDate" label="迁出日期" >
            </el-table-column>
        </el-table>
...
export default {
    ...
    methods: {
        submitForm(formName) {
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    ...
                    axios.get('http://172.20.10.8:8181/moveout/moveoutSearch', { params: _this.ruleForm }).then(function (resp) {
        ...
        page(currentPage) {
            ...
            if (_this.ruleForm.value == '') {
                axios.get('http://172.20.10.8:8181/moveout/moveoutList/' + currentPage + '/' + _this.pageSize).then(function (resp) {
                    _this.tableData = resp.data.data.data
                    _this.total = resp.data.data.total
                })
            } else {
    ...
    created() {
        const _this = this
        axios.get('http://172.20.10.8:8181/moveout/moveoutList/1/' + _this.pageSize).then(function (resp) {
            _this.tableData = resp.data.data.data
            _this.total = resp.data.data.total
        })
    }
