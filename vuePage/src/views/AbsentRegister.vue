...
<script>
    export default {
        ...
        methods: {
            buildingChange(){
                const _this = this
                axios.get('http://172.20.10.8:8181/absent/findDormitoryByBuildingId/'+_this.ruleForm.buildingId).then(function (resp) {
            ...
            dormitoryChange(){
                const _this = this
                axios.get('http://172.20.10.8:8181/absent/findStudentByDormitoryId/'+_this.ruleForm.dormitoryId).then(function (resp) {
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        axios.post('http://172.20.10.8:8181/absent/save',_this.ruleForm).then(function (resp) {
                            if(resp.data.code == 0){
                                _this.$alert('缺寝登记成功', '', {
        ...
        created() {
            const _this = this
            axios.get('http://172.20.10.8:8181/absent/buildingList').then(function (resp) {
